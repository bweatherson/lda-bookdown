...
for (j in 1:90){
  ...
  if (!the_categories$cat_num[j] == 13){
    category_table <- category_table %>%
      add_row(topic = j, 
              category = str_to_lower(the_categories$cat_name[j]), 
              subject = the_categories$sub_lower[j], 
  ...
  if (the_categories$cat_num[j] == 13){
    ...
    temp_category <- str_to_lower(paste(str_to_lower(temp_category_tibble$cat_name), sep = "/", collapse = "/"))
    category_table <- category_table %>%
      add_row(topic = j, 
