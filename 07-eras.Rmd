...
- Clear cache to get new names in
- Chance 'Consequentialism' to 'Population Ethics' so it fits
- Check everything really does fit
- Add spaces before various tables
- Add two tables to category/decade (distinctive)
...
But none of that compares to how little attention there was to Epistemology. Now again, you can argue that some of the Idealism had to do with epistemology. Certainly a lot of it had epistemological motivations. But work that looks at all like contemporary epistemology literally doesn't exist before 1945. At least, it doesn't exist in the journals. The discussion of knowledge in Russell's [The Problems of Philosophy](https://www.gutenberg.org/files/5827/5827-h/5827-h.htm) is more like modern epistemology than literally any article published in these journals around that time.
...
Apart from the names, the words in the final era are all fairly much as expected. I'll come back in the last chapter to 'credence', because I don't think everyone realises how new a term it is. And I guess I thought 'egalitarianism' would have been used enough in 1982-1998 to not appear here, but I guess not.
