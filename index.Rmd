--- 
title: "Text Mining Philosophy Journals"
...
I used this data to build a Latent Dirichlet Allocation (LDA) model of the journals using the [topicmodels](https://cran.r-project.org/package=topicmodels) package written by [Bettina Grün](http://ifas.jku.at/gruen/) and [Kurt Hornik](http://statmath.wu.ac.at/~hornik/).
...
facetstyle <-   theme_minimal() +
  theme(plot.title = element_text(size = rel(1), 
        ...
        panel.grid.major = element_line(color = "grey85", size = 0.07),
...
```{r first-facet-graph, fig.cap = "Proportion of Articles in Each Category"}
...
ggplot(tt, 
  ...
  geom_text(data = category_graph_labels,
            ...
            fontface = "bold", 
            size = 3) +
  labs(x = "Year", y = "Proportion of Articles", title = "Proportion of Articles in Each Category Per Year") +
...
The whole book was put together using the **bookdown** package, primarily built by Yihui Xie. This in turn is built on the **Pandoc** language, which was originally built by John MacFarlane. And the code uses tools from the **tidyverse** package throughout, which was originally built by Hadley Wickham.
...
This is a **draft**. Don't circulate it yet. I had been hoping to have a finished draft by the end of March 2020, but the virus got in the way. This is subject to very frequent change, and I'll be updating it as often as I can. This message will change substantially when the draft is complete.
