...
This is especially striking when you consider that as well as some of the more surprising figures to turn up here, like Arnold Geulincx and James Marsh, we also see Nietzsche, James,Mill and, when the article is particularly historical, Wittgenstein. I'd have thought those three alone would have made more impact than the under 1% numbers we see for many recent decades. (And they are very much part of the resurgence I alluded to just above.)
...
- Second, how often within the topic the word appears 10 or more times in an article.
