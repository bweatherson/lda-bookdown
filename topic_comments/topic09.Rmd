...
```{r t09b, fig.cap=the_categories$subject[jjj], fig.height= 5.2}
source('topic_comments/topic_summary_overall_graph.R')
```

```{r t09c, fig.cap=paste(the_categories$subject[jjj], "Articles in Each Journal")}
...
The mind-body problem is one of the oldest and most venerable problems around. (Actually, since we're discussing Stoljar, I should at this point acknowledge [his good point](http://dailynous.com/2017/11/07/philosophy-makes-progress-guest-post-daniel-stoljar/) that it is a class of problems not a problem, and missing this point leads one to seriously misstate the history of work in this field.) It was a big deal in nineteenth century philosophy, it is a big deal in twenty-frst century philosophy, and, appaently, it was an even bigger deal in philosophy in the 1920s and 1930s.
