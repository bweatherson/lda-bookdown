...
```{r t16b, fig.cap=the_categories$subject[jjj], fig.height= 5.2}
source('topic_comments/topic_summary_overall_graph.R')
```

```{r t16c, fig.cap=paste(the_categories$subject[jjj], "Articles in Each Journal")}
