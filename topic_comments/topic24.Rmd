...
```{r t24b, fig.cap=the_categories$subject[jjj], fig.alt = alt_text, fig.height= 5.2}
source('topic_comments/topic_summary_overall_graph.R')
```

```{r t24c, fig.cap=paste(the_categories$subject[jjj], "Articles in Each Journal"), fig.alt = alt_text_journals}
