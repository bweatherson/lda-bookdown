...
You don't see a Ryle-driven drop in this topic after World War II. I don't think this is due to Ryle's Humean sympathies. Rather, it's that Hume just wasn't that big a topic before World War II, so the rise in general interest in Hume studies offsets the fall in historical work being published in these twelve journals. It wasn't that there was no work on Hume. Keynes and Sraffa, for example, published their important argument that Hume was the author of the _Abstract_ in 1938. But it didn't get much attention in the philosophy journals until much more recently.

```{r graph-time-categories-t45, fig.cap = "Early Modern topics - Weighted Frequency of Articles", fig.height = 5, fig.alt = alt_text}
