...
```{r t72b, fig.cap=paste(the_categories$subject[jjj], fig.height= 5.2}
source('topic_summary_overall_graph.R')
```

```{r t72c, fig.cap=the_categories$subject[jjj], "Articles in Each Journal")}
cat("<br>")
