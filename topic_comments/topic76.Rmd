...
```{r t76b, fig.cap=paste(the_categories$subject[jjj], fig.height= 5.2}
source('topic_summary_overall_graph.R')
```

```{r t76c, fig.cap=the_categories$subject[jjj], "Articles in Each Journal")}
cat("<br>")
...
```{r modern-epistemology-graph, fig.cap= "Trends in Epistemology in the Last 25 years of the study"}
t <- weight_ratio %>%
...
#    scale_colour_discrete(labels = subject) + 
    ...
    labs(x = "Year", y = "Proportion of all journal articles", title = "Epistemology Topics") +
